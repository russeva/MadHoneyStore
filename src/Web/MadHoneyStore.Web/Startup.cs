namespace MadHoneyStore.Web
{
    ...
    using MadHoneyStore.Services.Mapping;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services.AddDbContext<ApplicationDbContext>(
                options => options.UseSqlServer(this.configuration.GetConnectionString("DefaultConnection"), b => b.MigrationsAssembly("MadHoneyStore.dll")));
